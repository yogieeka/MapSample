...
class CoffeeAPI
{
    ...
    init()
    {
        ...
        let client = Client(clientID: "BPI0BUIMJRTXHSNXUB2H0ZSNKUQUEI3DVY0QGE4BTSSE5ZSJ", clientSecret: "SBAZW4HCCFBX1MK0L4I3KVUO4DHGUK1PIJEIUWFDXZ0YX1RL", redirectURL: "");
    ...
    func getCoffeeShopsWithLocation(location:CLLocation)
    {
        if let session = self.session
        {
            ...
            parameters += [Parameter.radius: "200000"];
